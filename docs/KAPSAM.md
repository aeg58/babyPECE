...
| 3 | ~~Sürgü açılışta bugünün haftasına konuyor, 7–40 geziliyor~~ → **BU KAPANIŞ HATALIYDI**, aynı gün geri alındı | **YENİDEN AÇILDI → YAPILDI** *(2026-08-29)* | **Hata:** ajan sürgünün bugüne konduğunu ölçtü ama sürgünün **nerede** olduğunu ölçmedi. Sürgü sitenin içinde değil, inceleme sayfasının denetim kutusundaydı. Ölçüm: site içinde `input 0 · button 0`, site dışında `input 1 · button 1`. Yani yayınlanan sitede hafta gezinmesi **hiç yoktu**. *(Refleks 5'in tarif ettiği tuzak: kusurun kendisi değil, kusuru önlediği sanılan şeyin varlığı ölçülmüştü.)* **Çözüm:** Erdem'in önerisiyle **hafta şeridinin kendisi denetim oldu**; parmakla üzerinde gezilir, 7–40 arasına kilitli. **Reddedilenler:** ① dikey akış (34 ekran boyu sayfa, 2 saniye hedefini zorlardı) ② ekranı sağa sola kaydırma (tarama ekranındaki bakış etkisiyle ve yaş serisinin kendi yatay kaydırmasıyla çakışıyordu) |
