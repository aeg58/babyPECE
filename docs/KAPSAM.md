...
| 14 | Güvenlik ve gizlilik | **KARAR** | ajan → onay | Site **arama motorlarına kapatılır** (robots.txt dosyası ve sayfa içi işaret — **henüz üretilmedi**). Ziyaretçi ölçümü, çerez, dış servise veri gönderimi **yok** | Hassas bilgi ablanın hamileliğidir ve depo Erdem'in kararıyla kamuya açıldı. Geriye kalan tek koruma **dizine düşmemek**: adresi bilmeyen bulamamalı | **(a) Ziyaretçi ölçümü eklemek** — reddedildi: kişisel veri işlemeye başlar ve mevzuat elementini açar. **(b) Hiçbir şey yapmamak** — reddedildi: *"sadece ablam için"* kapsam kararını sessizce çiğner | — |
...
| 26 | Model, veri ve değerlendirme | **KONU DIŞI** | Sitede yapay zekâ çalışmıyor; bütün içerik önceden yazılmış sabit veri | **Tetik:** siteye üretken bir görsel/metin bileşeni eklenirse **ya da** yapay zekâyla üretilmiş bir görsel siteye girerse açılır — o zaman "bu görselin kaynağı ne" sorusu element 7'ye geri döner |
